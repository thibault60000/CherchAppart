var attr_control = 'data-controls',
    ...
    expand_all_text = 'Tout rétrécir',
    collapse_all_text = 'Tout agrandir';
...
$body.on('click', '.js-expandmore-button', function(event) {
    ...
    if ($this.attr(attr_expanded) === 'false') {
        ...
        var $allButton =  document.querySelectorAll('.js-expandmore-button');
        for( var i = 0; i < $allButton.length; i++){
            var $allButtonDest = $('#' + $allButton[i].attr(attr_control));
            $allButton[i].removeClass('is-opened').attr(attr_expanded, 'false');
            $allButtonDest.attr(attr_hidden, 'true');
        }
